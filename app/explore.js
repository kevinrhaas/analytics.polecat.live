...
(function () {
  ...
  // column — Studio.guessRegionScale (model.js), shared with the View Builder's Map
  // opts (VB-10) so both editors infer the same way. Only runs when the mapping is
  // (re)guessed (dataset/type pick), so a manual scale choice afterwards always wins.
