...
(function () {
  ...
  var COMMANDS = [
    ...
    // dashboard lifecycle
    { label: "New dashboard", hint: "Create", kw: "new create blank start build", run: function () { studio(); click("btnNew"); } },
    { label: "Browse examples", hint: "Create", kw: "examples gallery showcase templates samples", run: function () { studio(); click("btnExamples"); } },
    { label: "Open a .studio.json file", hint: "File", kw: "open import load file json", run: function () { studio(); click("btnImport"); } },
    { label: "Save spec (.studio.json)", hint: "File", kw: "save download export json spec", run: function () { studio(); click("btnSaveSpec"); } },
    { label: "Export dashboard (.html)", hint: "Export", kw: "export dashboard framework html cdf publish", run: function () { studio(); var b = document.querySelector('#menuExport button[data-exp="cdf"]'); if (b) b.click(); } },
    { label: "Export all artifacts (bundle)", hint: "Export", kw: "export all bundle zip artifacts", run: function () { studio(); var b = document.querySelector('#menuExport button[data-exp="all"]'); if (b) b.click(); } },
    { label: "Push to active server…", hint: "Export", kw: "push publish server pentaho deploy", run: function () { studio(); var b = document.querySelector('#menuExport button[data-exp="push"]'); if (b) b.click(); } },
    // editing
    { label: "Add text / annotation panel", hint: "Edit", kw: "text annotation note markdown richtext add panel", run: function () { studio(); click("btnAddText"); } },
    { label: "New data source", hint: "Data", kw: "new source data access cda query connect", run: function () { studio(); click("btnNewDS"); } },
    { label: "Undo", hint: "Edit", kw: "undo revert back step", run: function () { studio(); click("btnUndo"); } },
    { label: "Redo", hint: "Edit", kw: "redo forward step", run: function () { studio(); click("btnRedo"); } },
    // view / modes
    { label: "Toggle light / dark theme", hint: "View", kw: "theme dark light mode appearance color", run: function () { click("btnTheme"); } },
    { label: "Toggle sample / live data", hint: "Data", kw: "sample live data offline pentaho connect toggle", run: function () { studio(); click("btnLive"); } },
    { label: "Focus mode", hint: "View", kw: "focus present clean distraction zen", run: function () { studio(); click("morePresent"); } },
    { label: "Slideshow", hint: "Present", kw: "slideshow present slides fullscreen cycle", run: function () { studio(); click("moreSlideshow"); } },
    { label: "Demo mode", hint: "Present", kw: "demo live simulate refresh animate", run: function () { studio(); click("moreDemoMode"); } },
    { label: "Simple mode", hint: "View", kw: "simple beginner basic easy streamlined", run: function () { studio(); click("moreSimple"); } },
    // learn / manage
    { label: "Manage server connections", hint: "Connect", kw: "servers connections pentaho jndi kettle manage", run: function () { studio(); click("btnConn"); } },
    { label: "Take the tour", hint: "Learn", kw: "tour welcome intro walkthrough onboarding", run: function () { studio(); click("btnAbout"); } },
    { label: "Interactive tutorial", hint: "Learn", kw: "tutorial walkthrough guide learn steps", run: function () { studio(); click("moreTutorial"); } },
    { label: "Keyboard shortcuts", hint: "Learn", kw: "keyboard shortcuts keys hotkeys cheatsheet", run: function () { studio(); click("moreShortcuts"); } },
    { label: "Clear local data…", hint: "Manage", kw: "clear reset wipe local storage cache data", run: function () { studio(); click("moreClearData"); } },
