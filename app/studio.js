...
(function () {
  ...
  // R5+ slice 3: the dashboard-defaults config layer (default*/presets/applyDashboardDefaults)
  // moved to app/defaults.js — see Studio.Defaults. Aliased here so every existing call site
  // (Settings rendering, blank-dashboard seeding, the preset event handlers below) is unchanged.
  ...
  var stylePresets = Studio.Defaults.stylePresets, addStylePreset = Studio.Defaults.addStylePreset;
  var deleteStylePreset = Studio.Defaults.deleteStylePreset, applyStylePreset = Studio.Defaults.applyStylePreset;
  var templateVarSets = Studio.Defaults.templateVarSets, addTemplateVarSet = Studio.Defaults.addTemplateVarSet;
  var deleteTemplateVarSet = Studio.Defaults.deleteTemplateVarSet, applyTemplateVarSet = Studio.Defaults.applyTemplateVarSet;
  var customThemePresets = Studio.Defaults.customThemePresets, addCustomThemePreset = Studio.Defaults.addCustomThemePreset;
  var deleteCustomThemePreset = Studio.Defaults.deleteCustomThemePreset, applyCustomThemePreset = Studio.Defaults.applyCustomThemePreset;
  ...
  window.__studioAppTheme = { get: appTheme, set: setAppTheme, toDashboardTheme: appThemeToDashboardTheme }; // test hook
