/* welcome.js — first-run welcome / tour. Introduces Dashboard Studio (an
   analytics.polecat.live project) for building CDF/CDE/CDA dashboard components
   for the Pentaho platform. Shows once (localStorage), reopenable via the topbar ⓘ.
...
(function () {
  ...
  var STEPS = [
    { t: "Welcome to Dashboard Studio", ic: "P",
      h: "An <b>analytics.polecat.live</b> project — a modern, visual way to build Pentaho dashboard components (<b>CDF</b>, <b>CDE</b>, <b>CDA</b>) over your existing data.",
