...
(function () {
  ...
  function start() {
    ...
    ov.innerHTML = '<div class="g-card"><div class="g-logo">P</div><h1>Demonstration Dashboard Studio</h1>' +
      ...
      '<div class="g-note">Pentaho Solution Engineering · dashboardstudio.pentaho.space</div></div>';
