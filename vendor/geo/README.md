...
| `us-huc8-albers.json` | HUC8 (subbasin) watersheds, nationwide (all 50 states + DC), TopoJSON, pre-projected onto the SAME AlbersUsa 975×610 plane | USGS Watershed Boundary Dataset via the National Map `wbd` MapServer (US government work, public domain); generalized server-side (maxAllowableOffset 0.02°), reprojected + quantized by `tools/build-geo.mjs` |
