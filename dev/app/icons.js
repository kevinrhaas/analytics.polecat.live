...
(function () {
  ...
  var PATHS = {
    ...
    // Slice A: topbar What's-new (sparkle) + What's-next (compass) glyphs.
    sparkle:   '<path stroke-linecap="round" stroke-linejoin="round" d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9L12 3z"/><path stroke-linecap="round" stroke-linejoin="round" d="M18.5 14l.8 2.2 2.2.8-2.2.8-.8 2.2-.8-2.2-2.2-.8 2.2-.8.8-2.2z"/>',
    // ACTIVITY-1: topbar feedback (speech bubble) glyph.
    feedback:  '<path stroke-linecap="round" stroke-linejoin="round" d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/>',
    compass:   '<circle cx="12" cy="12" r="10"/><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76" stroke-linecap="round" stroke-linejoin="round"/>',
    ...
    // LF38: same eye glyph, slashed — the "revealed, click to hide" state of the
    // password show/hide toggle.
    "eye-off": '<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" stroke-linecap="round" stroke-linejoin="round"/><circle cx="12" cy="12" r="3" stroke-linecap="round"/><line x1="2" y1="2" x2="22" y2="22" stroke-linecap="round"/>',
    ...
    // M4.2 (object privacy): a closed padlock for the private/public toggle on
    // saved-object cards, monoline to match the rest of the registry.
    lock:      '<rect x="5" y="11" width="14" height="9" rx="1.5"/><path d="M8 11V7a4 4 0 0 1 8 0v4" stroke-linecap="round" stroke-linejoin="round"/>',
