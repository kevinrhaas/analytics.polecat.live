...
**Synthetic** — generated in JS at install time, which is what two of the five
shipped packs do (Conservation Insight and Data Management; Market Coverage,
Federal Contract Awards and Campaign Finance are the real ones). No files, no fetch, no licence question. It must still say so in plain
